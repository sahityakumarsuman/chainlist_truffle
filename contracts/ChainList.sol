...
contract ChainList {
    ...
    // this constructor will called when anyone will deploy contract on chain with address that account will be called as
    // owner account and this will be called only once when the contract is deployed
    function ChainList() public {
        owner = msg.sender;
    }

    // this will deactivate the contract on chain
